      ...
      >
        ...
        <div id="quiz-footer" className={styles.quizFooter}>
          <div id="reward-banner" hidden className={styles.rewardBanner}>
            ...
            <span id="reward-message" className={styles.rewardMsg}>{t("rewardCorrect")}</span>
          </div>
        ...
        <div id="quiz-final" className={`${styles.hidden} ${styles.quizFinal}`}>
          ...
          <Link href="/">
            <button className={`btn-primary ${styles.btnWide}`}>{t("finalBackHome")}</button>
          </Link>
          <Link href={`/topics/${slug}/review`}>
            <button className={`btn-secondary ${styles.btnWide}`}>{t("finalReview")}</button>
          </Link>
        </div>
      </main>
